    ...
    return (
        <div className='sidebar'>
          <div className="sidebar_headers">
             ...
             <div className="sidebar_headerRightSide">
                 <IconButton>
            ...
            <div className="sidebar_Search">
                <div className="sidebar_SearchContainers">
                   <FindInPageIcon />
                   <input placeholder="Start you new chats" type="text" />
               </div>
            </div>

            <div className="sidebarChatLists_broadcasts">
              <h5>BroadCasts Lists</h5>
              </div>
